  ...
  <div id="wrapper">
   <?php include("includes/header.php") ?>
    <nav id="tabs" class="top">
  		<ul>
        <li><a id="menuLanguages" href="#tabs-2">Computer Languages</a>
        <li><a id="menuTimezones" href="#tabs-1">Time Zones</a>
        <li><a id="menuUnicode" href="#tabs-3">Unicode </a>
      ...
      <article id="tabs-2"><?php include("includes/languages.php") ?></article>
      <article id="tabs-1"><?php include("includes/timezones.php") ?></article>     
      <article id="tabs-3" style="clear:left"><?php include("includes/unicodeList.php") ?></article>         
      ...
      <article id="tabs-5" style="clear:left"><?php include("includes/about.php") ?></article>
    </nav>
		<footer>
